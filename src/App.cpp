/**
*   EP28: "Batch Rendering"
*	EP29: "Batch Rendering - Colors"
*	EP30: "Batch Rendering - Textures"
*	EP31: "Batch Rendering - Dynamic Geometry"
*	
*	Ep31 enables one to move each individual rendered quad by changing its vertices.
*	In it, the VertexBuffer files are modified.
*	
*
*/
...
#include "tests/BasicRendererTest.h"
	...
	*/
...

	{
		...
		*/
		...
		testMenu->RegisterTest<test::BasicRendererTest>("Basic Renderer");
		testMenu->RegisterTest<test::TestTexture2D>("Texture 2D");
		testMenu->RegisterTest<test::TestBatchRendering>("Batch Rendering");
		testMenu->RegisterTest<test::TestBatchRenderingColors>("Batch Rendering - Color");

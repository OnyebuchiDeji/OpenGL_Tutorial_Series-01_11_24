...
***Regerence: The Cherno (2017) "Opengl Series", [Youtube], Available at: https://youtu.be/W3gAzLwfIP0?si=8T2iVkNg7LXJ8wY3***
...
+	Project Properties Setup:
	...
	3.	Right-click on Project in VS solution tree -> Scoll Down -> Open Properties
		...
		-	Click Apply and OK --- or just click OK 


## Screenshots Sequences
Consider some screenshots of the running program:

/**
*   EP27: "Faster Uniforms in OpenGL"; "How to make your UNIFORMS FASTER in OpenGL"
*
*   Demonstrates creating a Test that shows rendering a Texture on a Quad.
* 
*	Changes is 'Shader_v2.cpp' and 'Shader_v2.h'
*	No changes here though.
*	However, the concept had already been thought by the Cherno in previous ones
*/

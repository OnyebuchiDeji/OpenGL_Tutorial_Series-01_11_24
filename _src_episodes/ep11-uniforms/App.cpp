/**
*   EP11: "Uniforms in OpenGL"
*   Uniforms can only be setup after a Shader has been bound.
*   Here a Uniform is used to send caller vec4 values to the GPU.
*   And then a colour-changing animation is implemented to change the clours on the CPU and update what the GPU renders.
*   
*   This is used to syncrhonize the display with the device's VSync or the Refresh rate of the monitor:
*       Syncing Frame Rate
*       glfwSwapInterval(1);
*/

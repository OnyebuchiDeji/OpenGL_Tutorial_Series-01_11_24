/**
*   EP25: "Creating Tests in OpenGL"
* 
*   This is the follow-up from episode 24. It shows the Cherno's method/solution for creating
*   a Test library/menu.
* 
*   Compare it with my own method/solution, 'ep24-quest-test_menu'
*   
*/

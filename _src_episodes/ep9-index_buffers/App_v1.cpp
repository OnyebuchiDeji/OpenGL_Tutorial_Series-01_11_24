...
* 
*   This version 1 shows drawing the Square or Rectangle without Index Buffers; it emphasizes
*   the fact that vertices are repeated, which can get tedious.
*/
...
int main(void)
{
    ...
    *   But this is how it is without index buffers; 2 pairs of 6 vertices are specified
    *   for the two triangles that form the square.
    *   But as seend, some vertices are hebncce duplicated.
    *   index buffers remove these duplicate vertices as they are used to specify
    *   the order in which the vertices should be read/interpreted by OpenGL
    **/
    float positions[] = {
        -0.5f, -0.5f,
        0.5f, -0.5f,

...
* 
*   this version, 3, implements the ASSERT function using MACROS that inditifies the line and function that caused
*   the error.
*   Furthermore it reduces the number of lines needed to get an error to one by redefining and adding new MACROs.
...
int main(void)
{
    ...
    **/
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        GLCall(glDrawElements(GL_TRIANGLES, 6, GL_INT, nullptr)); //  <- used with an index buffer.

...
* 
*   This version shows the implemnetation without assert, hence it does not cause the execution break
*   that indicates the line and function that caused the error to occur. Version 2 does this.
* 
...
*   The meaning of the code then has to be searched out by converting it from decimal to hex and then
*   checking the (glew) Header files
*/

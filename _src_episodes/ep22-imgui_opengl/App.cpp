...
* 
*   Used ImGui to modify the values used in the Model Matrix
*/
        ...
        */
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            //  A Simple Custom Window
            {
                ...
                */
                ImGui::SliderFloat("x_slider", &translation.x, 0.0f, 960.0f);
                ImGui::SliderFloat("y_slider", &translation.y, 0.0f, 540.0f);

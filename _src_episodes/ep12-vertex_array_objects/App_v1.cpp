...
* 
*   THIS version shows how the code would look like without a Vertex Array Object
*/
  ...
  /*  glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, 3);
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        *   @Exp
        *   Now, bind them all.
        *   This is how it ends up looking like when not using a Vertex Array Object
        *   these have to be done every time.
        */
        //  bind shader
        GLCall(glUseProgram(shader_program));
        //  setup uniform
